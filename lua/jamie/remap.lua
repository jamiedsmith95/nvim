...
nnoremap("<leader>db", function() dap.continue() end)
nnoremap("<leader>bo", function() dap.step_over() end)
nnoremap("<leader>bi", function() dap.step_into() end)
nnoremap("<leader>bt", function() dap.step_out() end)
nnoremap("<leader>bb", function() dap.toggle_breakpoint() end)
nnoremap("<leader>bs", function() dap.set_breakpoint() end)
nnoremap("<leader>br", function() dap.repl.open() end)
nnoremap("<leader>bl", function() dap.run_last() end)
nnoremap("<leader>bh", function() dap.hover() end)
vnoremap("<leader>bh", function() dap.hover() end)
nnoremap("<leader>bp", function() dap.preview() end)
vnoremap("<leader>bp", function() dap.preview() end)
