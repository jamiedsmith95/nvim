...
nnoremap("<leader>sc", "<cmd>normal crs<CR>")
nnoremap("<leader>cc", "<cmd>normal crc<CR>")
nnoremap("<leader>pc", "<cmd>normal crp<CR>")
vnoremap("<leader>sc", "<cmd>'<,'>norm g/\\u/norm ncrs<CR>")
vnoremap("<leader>cc", "<cmd>'<,'>g/_/norm ncrc<CR>")
vnoremap("<leader>zpc", "<cmd>'<,'>g/[_\\u-]/norm ncrp<CR>")
nmap('y','<s-v>')
nmap('d','<s-v>')
nnoremap('U','<c-r>')
